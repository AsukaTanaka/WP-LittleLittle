...
class WP_Custom_Ticket extends WP_List_Table { 
    /**
    ...
    public function get_columns()
    {
        $columns = array(
            ...
            'id' => __('#', 'Ticket'),
            'fullname' => __('Tên', 'Ticket'),
            'phone' => __('Số Điện Thoại', 'Ticket'),
            'email' => __('Email', 'Ticket'),
            'status' => __('Trạng Thái', 'Ticket'),
            'start_use' => __('Ngày Sử Dụng', 'Ticket'),
            'create_at' => __('Ngày Tạo', 'Ticket'),
        );
...
function WP_Ticket_Form()
{
    $obj = new WP_Custom_Ticket();
    $obj->prepare_items();
    ...
    <div class="wrap">
        ...
        <h2 class="wp-heading-inline"><?php _e('Danh Sách Trạng Thái Vé', 'Ticket')?></h2>
        <form id="ticket-table" method="GET" enctype="multipart/form-data">
