...
class WP_Custom_Bill extends WP_List_Table { 
    /**
    ...
    public function column_default($item, $column_name)
    {
        switch ($item[$column_name]) 
        {
            ...
            case '1' : 
                return '1';
            case $item['email'] :
                return base64_decode($item['email']);
    ...
    public function get_columns()
    {
        $columns = array(
            ...
            'id' => __('#', 'Bill'),
            'start_date' => __('Ngày Sử Dụng', 'Bill'),
            'email' => __('Email', 'Bill'),
            'ticket_id' => __('Vé', 'Bill'),
        );
...
function WP_Bill_Form()
{
    $obj = new WP_Custom_Bill();
    $obj->prepare_items();
    ...
    <div class="wrap">
        ...
        <h2 class="wp-heading-inline"><?php _e('Danh Sách Hóa Đơn', 'Bill')?></h2>
        <form id="bill-table" method="GET" enctype="multipart/form-data">
